          ...
          <div>
            ...
            >
              ...
              <div style={{ lineHeight: 1.7 }}>
                ...
                “PlasmoVoice Chat” вас могут кикнуть, или даже дать варн в случае игнорирования.
              </div>
            </div>
          ...
          >
            <div style={{ ...cardStyle, overflow: "hidden" }}>
              ...
              <div style={{ padding: 24 }}>
                ...
                >
                  {[
                    ["Фишки", "Своя голова, сохранение инвентаря, особый статус"],
                    ["Преимущества", "Удобные возможности, красивое оформление и больше уникальности"],
                    ["Зачем брать", "Поддержка проекта и заметный образ на сервере"],
                  ].map(([title, value]) => (
                    <div
                      key={title}
                      style={{
                    ...
                    >
                      ...
                      <div style={{ marginTop: 10, color: colors.text, lineHeight: 1.6 }}>
                        {value}
                      </div>
                    </div>
                  ))}
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ textAlign: "right" }}>
                        <div style={{ fontSize: 34, fontWeight: 900 }}>{plan.price}₽</div>
                        <div style={{ marginTop: 6, color: colors.softText, fontSize: 13 }}>
                          {plan.period}
                        </div>
                      </div>
                    </div>
      ...
      {selectedPlan && (
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div>
                  ...
                  <div style={{ marginTop: 6, color: colors.softText }}>{selectedPlan.description}</div>
                </div>
                <div style={{ textAlign: "right" }}>
                  <div
                    style={{
            ...
            <div style={{ ...cardStyle, background: colors.panelSoft, padding: 16, marginTop: 18 }}>
              <div style={{ fontWeight: 800, marginBottom: 10 }}>Почему выбрать этот вариант</div>
              <div style={{ display: "grid", gap: 8 }}>
            ...
            >
              ...
              <div style={{ marginTop: 6 }}>Статус: демо-макет страницы</div>
            </div>
            ...
            >
              <div style={{ color: colors.muted, fontSize: 13, lineHeight: 1.6, maxWidth: 360 }}>
                Покупая подписку, вы подтверждаете правильность никнейма,
                согласие с правилами проекта и условиями активации цифровой услуги.
              </div>

              <button
                disabled={!nickname || !accepted}
                style={{
                  ...pixelButton("#86efac", "#111827"),
                  opacity: !nickname || !accepted ? 0.55 : 1,
                  cursor: !nickname || !accepted ? "not-allowed" : "pointer",
                }}
                onClick={() => alert("Дальше можно подключить реальную оплату")}
              >
                Перейти к оплате
              </button>
            </div>
